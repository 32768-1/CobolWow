...
namespace CobolWow.Tools.Cryptography
{
   /// <summary>
   ...
   public class SRP6
   {
      ...
      [DllImport("LIBEAY32.DLL", CallingConvention = CallingConvention.Cdecl, EntryPoint = "BN_bin2bn")]
      ...
      [DllImport("LIBEAY32.DLL", CallingConvention = CallingConvention.Cdecl, EntryPoint = "BN_CTX_free")]
      private static extern int BN_ctx_free(IntPtr a);

      [DllImport("LIBEAY32.DLL", CallingConvention = CallingConvention.Cdecl, EntryPoint = "BN_CTX_new")]
      private static extern IntPtr BN_ctx_new();

      [DllImport("LIBEAY32.DLL", CallingConvention = CallingConvention.Cdecl)]
      private static extern int BN_div(IntPtr dv, IntPtr r, IntPtr a, IntPtr b, IntPtr ctx);

      [DllImport("LIBEAY32.DLL", CallingConvention = CallingConvention.Cdecl, EntryPoint = "BN_free")]
      ...
      [DllImport("LIBEAY32.DLL", CallingConvention = CallingConvention.Cdecl, EntryPoint = "BN_new")]
